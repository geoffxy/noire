...
# This script is used to release a new version of Noire.
...
function make_and_deploy_release() {
  ...
  twine upload -r pypi "dist/noire-${NEXT_CLI_VERSION}*"
...
function release_main() {
  ...
  NEXT_VERSION=$(cd ../src && python3 -c "import noire; print(noire.__version__)")
...
function main() {
  echo ""
  echo_blue "Noire Build and Release Tool"
  echo_blue "============================"
